                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if (_balanceController.text.isNotEmpty) {
                                var url = await balanceViewModel.getInvoice(
                                    context,
                                    consumerViewModel.consumerProfile!,
                                    int.parse(_balanceController.text.trim()));
                                if (url != null) {
                                  ;
                                ...
                                showCustomSnackBar(
                                    context, "field harus diisi.",
                                    color: Colors.red);
                              }
                            },
                            child: Text("Tambah Saldo",style: TextStyle(color: Colors.white),)))
                  ],
                ),
              ),
            ),
